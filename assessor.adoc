...
. When you are writing someone's review and request input from others, what
  percentage of people reply? Is the input valuable? Are you soliciting input in
  via the tool or in person?
